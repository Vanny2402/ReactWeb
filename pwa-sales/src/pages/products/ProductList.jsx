  ...
  return (
    <div className="p-4 pb-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <input
          type="text"
          placeholder="ស្វែងរកតាមឈ្មោះ ឬ ប្រភេទផលិតផល..."
...
function ProductCard({ product, Purchase, Sale ,onEdit}) {
  ...
  return (
    <div className="bg-white shadow-md rounded-xl p-4 hover:shadow-lg transition border relative">
      ...
      {/* Product Name */}
      <h2 className="text-lg font-bold mb-2">{product.name}  ({product.productType})</h2>
      ...
      <div className="text-sm text-gray-600 space-y-1">
        <p className="flex items-center justify-between">
          ...
          <span
            className={`px-1 py-1 rounded text-white ${product.stock > 10
                ? "bg-green-600"
                : product.stock > 0
                  ? "bg-yellow-500"
                  : "bg-red-600"
